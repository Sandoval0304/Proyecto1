...
public void escuchar(ActionListener controlador){
  btnSalirInstrucciones.addActionListener(controlador);
    ...
    private void initComponents() {
        ...
        btnSalirInstrucciones.setIcon(new javax.swing.ImageIcon(getClass().getResource("/btnRegresar.jpg"))); // NOI18N
        btnSalirInstrucciones.setText("Salir de Instrucciones");
        ...
        getContentPane().add(btnSalirInstrucciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 620, 170, 70));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/instrucc1.png"))); // NOI18N
